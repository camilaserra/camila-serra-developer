      ...
      <div className="main_container">
        ...
        <div className="grid grid-cols-12 gap-6">
          {dataOrdenada.map((servico, index) => (
            <a rel="noreferrer" target="_blank" href={servico.data.link_para_o_site as string} key={servico.id} className="card-skills-wrapper col-span-12 sm:col-span-6 md:col-span-4 lg:col-span-4">
                <div className="box">
